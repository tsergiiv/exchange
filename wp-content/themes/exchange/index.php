        ...
        <div class="main">
            <section class="main-head container middle">
                <div class="main-head-wrap">
                    <div class="main-head-left">
                        ...
                        <h1 class="section-header big">Pick the<span class="word-accent violet">best exchange<span class="word-accent-square left"></span><span class="word-accent-square right"></span></span><span class="word-accent orange">for you<span class="word-accent-square left"></span><span class="word-accent-square right"></span></span></h1>
                        ...
                        <form class="form" action="/top">
                            <div class="form-group">
                                ...
                                <div class="form-custom-select select-country">
                                    <div class="form-custom-select-chosen"><span class="form-custom-select-chosen-name">{{ selected_country_name }}</span></div>
                            ...
                            <button class="btn form-btn"><span class="btn-arrow"></span><span class="btn-text">Find the best exchange offer</span></button>
                        </form>
                    </div>
                </div>
            </section>
                ...
                <div class="table-wrap">
                    ...
                    <div class="table-row" v-for="(exchanger, index) in all_exchanges">
                        <div class="table-elem">
                            <div class="table-name"><img class="table-name-icon" :src="'<?php bloginfo('template_url'); ?>/assets/img/content/table/'+exchanger.name.toLowerCase().replace('.', '')+'-logo.svg'" alt="Binance Logo"><span class="table-name-text">{{ exchanger.name }}</span></div><a class="table-link-mob" href="">CoinCub Review
                        ...
                        <div class="table-elem"><span class="table-heading">Based in</span>
                            <div class="table-based"><span class="table-based-val">{{ exchanges_bassed[exchanger.coinGeckoId] }}</span></div>
                        </div>
                        ...
                        <div class="advantages-wrap">
                            <div class="advantages-elem green">
                                <div class="advantages-elem-content">
                                    ...
                                    <div class="advantages-text"><span class="advantages-text-accent">Fees: </span>Avoid expensive hidden fees.</div>
                                </div>
                            </div>
                            <div class="advantages-elem orange">
                                <div class="advantages-elem-content">
                                    ...
                                    <div class="advantages-text"><span class="advantages-text-accent">Legal: </span>Ensure all your transactions are above board</div>
                                </div>
                            </div>
                            <div class="advantages-elem purple">
                                <div class="advantages-elem-content">
                                    <div class="advantages-img"><img class="advantages-img-content" src="<?php bloginfo('template_url'); ?>/assets/img/content/advantages/advantages-img-7.png" alt="Advantages image #3"></div>
                                    <div class="advantages-text"><span class="advantages-text-accent">Location: </span>Find services available in your country.</div>
                                </div>
                            </div>
                            <div class="advantages-elem orange">
                                <div class="advantages-elem-content">
                                    ...
                                    <div class="advantages-text"><span class="advantages-text-accent">Exchange: </span>Compare exchanges to find the best one for you.</div>
                                </div>
                            </div>
                            <div class="advantages-elem purple">
                                <div class="advantages-elem-content">
                                    ...
                                    <div class="advantages-text"><span class="advantages-text-accent">Perks: </span>Find opportunities to earn rewards and bonuses.</div>
                                </div>
                            </div>
                            <div class="advantages-elem green">
                                <div class="advantages-elem-content">
                                    ...
                                    <div class="advantages-text"><span class="advantages-text-accent">Security: </span>Make sure your funds are protected.  </div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="first first-tab middle">
                <div class="first-head">
                    ...
                    <h1 class="section-header m"> <span class="word-accent orange">Buying Bitcoin?<span class="word-accent-square left"></span><span class="word-accent-square right"></span></span></h1>
                </div>
                <div class="first-wrap">
                    <div class="first-img"><img class="first-img-content" src="<?php bloginfo('template_url'); ?>/assets/img/content/first/first-img-1.png" alt="First Time Image"></div>
                        ...
                        <div class="first-tab-wrap">
                            <div class="first-tab-nav">
                                <div class="tab-nav-link first-tab-nav-link active" data-tab-link="1">
                                    ...
                                    </div><span class="first-tab-nav-link-text">Step 1 </span>
                                </div>
                                <div class="tab-nav-link first-tab-nav-link" data-tab-link="2">
                                    ...
                                    </div><span class="first-tab-nav-link-text">Step 2 </span>
                                </div>
                                <div class="tab-nav-link first-tab-nav-link" data-tab-link="3">
                                    ...
                                    </div><span class="first-tab-nav-link-text">Step 3 </span>
                                </div>
                                <div class="tab-nav-link first-tab-nav-link" data-tab-link="4">
                                    ...
                                    </div><span class="first-tab-nav-link-text">Step 4 </span>
                                </div>
                                <div class="tab-nav-link first-tab-nav-link" data-tab-link="5">
                                    ...
                                    </div><span class="first-tab-nav-link-text">Step 5</span>
                                </div>
                            </div>
                            <div class="first-tab-content tab-content">
                                <div class="tab-elem first-tab-elem active" data-tab-elem="1">
                                    ...
                                    </div><a class="btn first-btn" href=""><span class="btn-arrow"></span><span class="btn-text">Choose pair</span></a>
                                </div>
                                ...
                                <div class="tab-elem first-tab-elem" data-tab-elem="3">
                                    <div class="first-text">
                                        <p>
                                            ...
                                            set up two-factor authentication and read the exchange security recommendations.
                                        ...
                                        <p>
                                            If you're very worried about this, it might be worth it to prioritize exchanges
                                ...
                                <div class="tab-elem first-tab-elem" data-tab-elem="4">
                                    <div class="first-text">
                                        <p>
                                            Funding: You made it! You’ve signed up, verified your account, locked it down
                                            and made it difficult to hack. You’re now ready to purchase crypto. Most
                                            exchanges allow you to purchase crypto via card or bank transfer, though with
