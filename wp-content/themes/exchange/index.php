                                    ...
                                    <div class="form-custom-select-dd">
                                        <div class="form-custom-select-dd-wrap">
                                            ...
                                            <div v-for="(country, index) in countrys"
                                                 :class="'form-custom-select-elem'+(country.value == selected_country ? ' active' : '')">
                                                <input class="form-custom-select-elem-radio" type="radio"
                                                       name="customSelectCountry" :value="country.value"
                                                       :checked="country.value == selected_country"
                                                       data-el-chenged="selected_country"><span
                                                        class="form-custom-select-elem-name">{{ country.name }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-custom-select select-currency">
                                        ...
                                        <div class="form-custom-select-dd">
                                            <div class="form-custom-select-dd-wrap">
                                                ...
                                                <div v-for="(currency, index) in options_currencys"
                                                     :class="'form-custom-select-elem'+(currency.value == selected_currency ? ' active' : '')">
                                                    <input class="form-custom-select-elem-radio" type="radio"
                                                           name="customSelectCurrency" :value="currency.value"
                                                           :checked="currency.value == selected_currency"
                                                           data-el-chenged="selected_currency"><img
                                                            class="form-custom-select-elem-icon" :src="currency.flag"
                                                            :alt="currency.value"><span
                                                            class="form-custom-select-elem-name">{{ currency.name
                                                    }}</span><span
                                                            class="form-custom-select-elem-short">{{ currency.code }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-custom-select select-coin">
                                        ...
                                        <div class="form-custom-select-dd">
                                            <div class="form-custom-select-dd-wrap">
                                                ...
                                                <div v-for="(coin, index) in options_destination_coins"
                                                     :class="'form-custom-select-elem'+(coin.code == selected_destination_coin ? ' active' : '')">
                                                    <input class="form-custom-select-elem-radio" type="radio"
                                                           name="customSelectCoin" :value="coin.code"
                                                           :checked="coin.code == selected_destination_coin"
                                                           data-el-chenged="selected_destination_coin">
                                                    <!-- <img class="form-custom-select-elem-icon" :src="'<?php bloginfo('template_url'); ?>/assets/img/content/select/'+coin.code.toLowerCase().replace('.', '')+'-icon.svg'" :alt="coin.code"> --><span
                                                            class="form-custom-select-elem-name">{{ coin.name }}</span><span
                                                            class="form-custom-select-elem-short">{{ coin.code }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
