...
Vue.component('exchanges_country', {
  ...
  data () {
        return {
          ...
          exchanges_country: {
            'HK' : ['luno' , 'eToro' , 'revolut', 'gdax'],
            'JP' : ['luno' , 'kucoin' , 'eToro' , 'gdax' , 'blockchaincom'],
            'MX' : ['luno' , 'revolut'],
            'IN' : ['luno' , 'gdax' , 'revolut'],
            'US' : ['luno' , 'kucoin' , 'gate' , 'crypto_com' , 'Binance'],
            'NZ' : ['luno' , 'gdax' , 'revolut'],
            'CA' : ['luno' , 'eToro', 'revolut'],
            'BE' : ['eToro'],
            'SG' : ['eToro'],
            'NL' : ['gdax'],
            'DE' : ['gdax'],
            ...
            .then(response => {
              if (response.data) {
                ...
                for(var index in this.all_exchanges) {
                  if (this.filter(this.all_exchanges[index].apiId) && this.display_n_exchanges > n_exchanges) {
